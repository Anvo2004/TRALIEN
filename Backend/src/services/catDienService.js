...
// tách riêng theo xã. Trước đây có lọc chỉ giữ khu vực xác nhận thuộc Trà Liên
// (Trà Đông/Trà Nú/Trà Kót...), nhưng theo yêu cầu xã (2026-09-14) đổi sang
// LẤY TOÀN BỘ trạm của khu vực Trà My — giống cách Thăng Điền dùng chung feed
// Thăng Bình — MiniApp có sẵn bộ lọc "chọn trạm" (lich-cup-dien.jsx) để dân tự
// chọn khu vực mình quan tâm.
